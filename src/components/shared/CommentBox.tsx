...
import PostMedia from "./PostMedia"; // আপনার আগের তৈরি করা PostMedia কম্পোনেন্টটি ইমপোর্ট করা হলো
...
const CommentModal = ({
    ...
    return (
        <Dialog>
            ...
            >
                {/* বাম পাশে সরাসরি আপনার আগের বানানো PostMedia কম্পোনেন্টটি পাস করে দেওয়া হলো */}
                ...
                {/* ডান পাশের কমেন্ট ও অন্যান্য সেকশন */}
